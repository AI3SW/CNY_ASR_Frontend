...
public class MicEncoder_Editor : Editor
{
    ...
    SerializedProperty StartOnEnableProp;
    ...
    void OnEnable()
    {
        ...
        StartOnEnableProp = serializedObject.FindProperty("StartOnEnable");
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUILayout.BeginVertical("box");
        {
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                GUILayout.BeginHorizontal();
                EditorGUILayout.PropertyField(StartOnEnableProp, new GUIContent("Start On Enabled"));
                GUILayout.EndHorizontal();
            }
